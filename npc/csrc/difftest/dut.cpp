...
void init_difftest(const char *ref_so_file, long img_size, int port) {
  ...
  // ref_difftest_memcpy = decltype(ref_difftest_memcpy)(dlsym(handle,
  // "difftest_memcpy")); assert(ref_difftest_memcpy);

  ref_difftest_regcpy =
      (decltype(ref_difftest_regcpy))dlsym(handle, "difftest_regcpy");
  assert(ref_difftest_regcpy);

  ref_difftest_exec =
      decltype(ref_difftest_exec)(dlsym(handle, "difftest_exec"));
  assert(ref_difftest_exec);

  // ref_difftest_raise_intr =
  //     decltype(ref_difftest_raise_intr)(dlsym(handle,
  //     "difftest_raise_intr"));
  // assert(ref_difftest_raise_intr);

  void (*ref_difftest_init)(int) =
      decltype(ref_difftest_init)(dlsym(handle, "difftest_init"));
